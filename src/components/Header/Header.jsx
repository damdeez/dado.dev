...
const Header = () => (
  <header className={styles.header}>
    ...
    <div className={styles.headerText}>
      ...
      <h2>I am a Software Engineer focused on the the Web.</h2>
      <h3>You can check out my resume <Link to="/resume">here</Link>. You can also find me on these social mediums: <a href="https://github.com/damdeez">Github</a>, <a href="https://twitter.com/damdeez">Twitter</a>, <a href="https://www.linkedin.com/in/damirharambasic">LinkedIn</a>, or good ol&apos; <a href="mailto:damir.hara@gmail.com">email</a>.</h3>
    </div>
  </header>
);
